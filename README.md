...
> 해당 애플리케이션을 실행하기 위해서는 4leaf client 파일은 별도로 준비하셔야 합니다.
...
> 상태: **작업 중 / 설험 상태** — `v1.0` 버전까지 구조가 변경될 수 있습니다.
...
- 4Leaf Browser: 아카이브나 커뮤니티를 통해 준비해주세요. 그리고 4Leaf Browser 클라이언트 파일 전체를 소스 코드가 있는 Resources 폴더 안에 복사합니다.
