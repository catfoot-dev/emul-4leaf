...
pub(crate) fn handle_ping(pkt: &ProtocolPacket, ch: u16) -> HandlerOutcome {
...
pub(crate) fn handle_inventory(pkt: &ProtocolPacket, ch: u16) -> HandlerOutcome {
    crate::emu_socket_log!(
...
pub(crate) fn handle_main_type_d4(pkt: &ProtocolPacket, ch: u16) -> HandlerOutcome {
    crate::emu_socket_log!(
