...
impl DllIMM32 {
    ...
    pub fn handle(uc: &mut Unicorn<Win32Context>, func_name: &str) -> Option<ApiHookResult> {
        callee_result(match func_name {
            ...
            "ImmIsUIMessageA" => {
                crate::emu_log!("[IMM32] ImmIsUIMessageA(...)");
                Some((4, Some(0))) // FALSE
            }
            ...
            "ImmGetConversionStatus" => {
                crate::emu_log!("[IMM32] ImmGetConversionStatus(...)");
                Some((3, Some(0))) // FALSE
            }
            ...
            "ImmGetContext" => {
                ...
                crate::emu_log!("[IMM32] ImmGetContext(...) -> {:#x}", himc);
            ...
            "ImmReleaseContext" => {
                crate::emu_log!("[IMM32] ImmReleaseContext(...)");
                Some((2, Some(1))) // TRUE
            }
            ...
            "ImmSetConversionStatus" => {
                crate::emu_log!("[IMM32] ImmSetConversionStatus(...)");
                Some((3, Some(1))) // TRUE
            }
